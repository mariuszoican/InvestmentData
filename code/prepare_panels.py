...
main_name = "main_2026-07-01"
post_name = "post_exp_2026-07-01"
pre_name = "intro_2026-07-01"

session_code = [
    "4ovtf4e6"
]  # Session June 30, 2026 on Prolific with 100 participants that reported using trading apps.

# Read experiment file
data = pd.read_csv(f"../raw_data/{main_name}.csv")
meta = pd.read_csv("../raw_data/round_metadata.csv")  # load seed and imbalance
post_exp = pd.read_csv(f"../raw_data/{post_name}.csv")  # post experimental raw_data
pre_exp = pd.read_csv(f"../raw_data/{pre_name}.csv")  # pre experiment
...
data.to_csv("../processed_data/processed_panels.csv")
